...
function Header() {
  return (
    <div className='flex justify-around shadow-2x px-5 py-2 bg-gray-400'>
      <div className='text-3xl font-bold text-zinc-950 '>paytm</div>
      <div className='my-1'>
        <a className="navbar navbar-expand-lg navbar-light bg-light font-medium text-xl mx-2 my-1" href='https://github.com/Radhikagarg20/Digital-Payment-Clone' target='_blank'>Github</a>
      </div>
      <div className='flex' >
